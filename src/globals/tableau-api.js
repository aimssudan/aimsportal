...
(function () {
    ...
    (function (global) {
        ...
        ss._makeGenericTypeName = function (genericType, typeArguments) {
            ...
            for (var i = 0; i < typeArguments.length; i++) result += (i === 0 ? "[" : ",") + "[" + ss.getTypeFullName(typeArguments[i]) + "]";
            result += "]";
            return result;
        };
        ...
        ss.anonymousType = function () {
            ...
            if (!type) {
                ...
                var infos = members.map(function (m) {
                    return { name: m[1], typeDef: type, type: 16, returnType: m[0], getter: { name: "get_" + m[1], typeDef: type, params: [], returnType: m[0], fget: m[1] } };
                });
                infos.push({
                    name: ".ctor",
                    typeDef: type,
    ...
    (function () {
        ...
        var d = (global.tab.CookieHelper = ss.mkType(a, "tab.CookieHelper", null, null, {
            getValueForCookie: function (n) {
                var o = e.getCookie().match(new RegExp("(?:^|;) ?" + n + "=([^;]*)(?:;|$)"));
        ...
        var e = (global.tab.DocumentHelper = ss.mkType(a, "tab.DocumentHelper", null, null, {
        ...
        var f = (global.tab.EscapingUtil = ss.mkType(a, "tab.EscapingUtil", null, null, {
        ...
        var i = (global.tab.Logger = ss.mkType(
            ...
            },
            {
                ...
                filterByType: function (n, o) {
                    o = o || 0;
                    i.$0(function (p, q) {
                        return q >= o && ss.referenceEquals(p.get_name(), ss.getTypeName(n));
                    });
                },
        ...
        var j = (global.tab.LoggerLevel = ss.mkEnum(a, "tab.LoggerLevel", { all: 0, debug: 1, info: 2, warn: 3, error: 4, off: 5 }));
        var k = (global.tab.ScriptEx = ss.mkType(a, "tab.ScriptEx"));
        var l = (global.tab.UriExtensions = ss.mkType(a, "tab.UriExtensions", null, null, {
        ...
        (function () {
            ...
            }
            {
                ...
                for (var s = 0; s < p.length && (ss.isNullOrUndefined(q) || ss.isNullOrUndefined(r)); ++s) {
                    var t = p[s];
    ...
    (function () {
        ...
        var f = (global.tab._ApiObjectRegistry = ss.mkType(a, "tab._ApiObjectRegistry", null, null, {
            ...
            $1: function (e) {
                return function () {
                    ...
                    if (ss.isNullOrUndefined(bk)) {
                        throw q.createInternalError("No creation function has been registered for interface type '" + bi + "'.");
                    }
                    var bl = bk();
                    return bl;
                };
            ...
            $2: function (e) {
                return function () {
                    var bi = window._ApiObjectRegistryGlobalState.singletonInstanceRegistry;
            ...
            },
            {
                ...
                $0: function (e, bi) {
                    ...
                    this.$2.push(function (bk) {
                        bk.then(e, bi).then(ss.mkdel(bj, bj.resolve), ss.mkdel(bj, bj.reject));
                    });
        ...
        var m = (global.tab._jQueryShim = ss.mkType(a, "tab._jQueryShim", null, null, {
            ...
            type: function (e) {
                return ss.isNullOrUndefined(e) ? String(e) : m.$9[m.$e.call(e)] || "object";
            },
            trim: function (e) {
                if (ss.isValue(m.$f)) {
                    return ss.isNullOrUndefined(e) ? "" : m.$f.call(e);
                }
                return ss.isNullOrUndefined(e) ? "" : e.toString().replace(m.$g, "").replace(m.$h, "");
            },
            parseJSON: function (e) {
                ...
                if (m.$b.test(e.replace(m.$c, "@").replace(m.$d, "]").replace(m.$a, ""))) {
        ...
        var q = (global.tab._TableauException = ss.mkType(a, "tab._TableauException", null, null, {
        ...
        var r = (global.tab._Utility = ss.mkType(a, "tab._Utility", null, null, {
            ...
            hasClass: function (e, bi) {
                var bj = new RegExp("[\\n\\t\\r]", "g");
                return ss.isValue(e) && (" " + e.className + " ").replace(bj, " ").indexOf(" " + bi + " ") > -1;
            },
            ...
            isElementOfTag: function (e, bi) {
                return ss.isValue(e) && e.nodeType === 1 && ss.referenceEquals(e.tagName.toLowerCase(), bi.toLowerCase());
            },
            ...
            visibleContentRectInDocumentCoordinates: function (e) {
                ...
                for (var bj = e.parentElement; ss.isValue(bj) && ss.isValue(bj.parentElement); bj = bj.parentElement) {
            ...
            getVisualViewportRect: function (e) {
                ...
                if (ss.isValue(bi)) {
                    return new p(ss.trunc(bi.pageLeft), ss.trunc(bi.pageTop), ss.trunc(bi.width), ss.trunc(bi.height));
                } else {
                    return null;
                }
            },
        ...
        var t = (global.tab.ApiDateRangeType = ss.mkEnum(a, "tab.ApiDateRangeType", { last: "last", lastn: "lastn", next: "next", nextn: "nextn", curr: "curr", todate: "todate" }, true));
        var u = (global.tab.ApiDeviceType = ss.mkEnum(a, "tab.ApiDeviceType", { default: "default", desktop: "desktop", tablet: "tablet", phone: "phone" }, true));
        var v = (global.tab.ApiEnumConverter = ss.mkType(a, "tab.ApiEnumConverter", null, null, {
        ...
        var y = (global.tab.ApiFieldRoleType = ss.mkEnum(a, "tab.ApiFieldRoleType", { dimension: "dimension", measure: "measure", unknown: "unknown" }, true));
        var z = (global.tab.ApiFilterType = ss.mkEnum(a, "tab.ApiFilterType", { categorical: "categorical", quantitative: "quantitative", hierarchical: "hierarchical", relativedate: "relativedate" }, true));
        var A = (global.tab.ApiFilterUpdateType = ss.mkEnum(a, "tab.ApiFilterUpdateType", { all: "all", replace: "replace", add: "add", remove: "remove" }, true));
        var B = (global.tab.ApiMessageHandler = ss.mkType(a, "tab.ApiMessageHandler", function () {}, {
            handleEventNotification: function (e, bi) {
        ...
        var D = (global.tab.ApiNullOption = ss.mkEnum(a, "tab.ApiNullOption", { nullValues: "nullValues", nonNullValues: "nonNullValues", allValues: "allValues" }, true));
        var E = (global.tab.ApiParameterAllowableValuesType = ss.mkEnum(a, "tab.ApiParameterAllowableValuesType", { all: "all", list: "list", range: "range" }, true));
        var F = (global.tab.ApiParameterDataType = ss.mkEnum(a, "tab.ApiParameterDataType", { float: "float", integer: "integer", string: "string", boolean: "boolean", date: "date", datetime: "datetime" }, true));
        var G = (global.tab.ApiPeriodType = ss.mkEnum(a, "tab.ApiPeriodType", { year: "year", quarter: "quarter", month: "month", week: "week", day: "day", hour: "hour", minute: "minute", second: "second" }, true));
        var H = (global.tab.ApiSelectionUpdateType = ss.mkEnum(a, "tab.ApiSelectionUpdateType", { replace: "replace", add: "add", remove: "remove" }, true));
        var I = (global.tab.ApiSheetSizeBehavior = ss.mkEnum(a, "tab.ApiSheetSizeBehavior", { automatic: "automatic", exactly: "exactly", range: "range", atleast: "atleast", atmost: "atmost" }, true));
        var J = (global.tab.ApiSheetType = ss.mkEnum(a, "tab.ApiSheetType", { worksheet: "worksheet", dashboard: "dashboard", story: "story" }, true));
        ...
        var L = (global.tab.ApiToolbarButtonName = ss.mkEnum(a, "tab.ApiToolbarButtonName", { redo: "redo", undo: "undo" }, true));
        var M = (global.tab.ApiToolbarPosition = ss.mkEnum(a, "tab.ApiToolbarPosition", { top: "top", bottom: "bottom" }, true));
        var N = (global.tab.CommandReturnHandler$1 = ss.mkType(a, "tab.CommandReturnHandler$1", function (e) {
            ...
            },
            {
                ...
                sendCommand: function (e) {
                    return function (bi, bj, bk) {
                        ...
                        if (!r.hasWindowPostMessage() || ss.isNullOrUndefined(bl) || ss.isNullOrUndefined(bl.contentWindow)) {
                            return;
                        }
                ...
                $1: function (e) {
                    ...
                    var bl = this.$6[bk];
                    if (ss.isNullOrUndefined(bl) || !ss.referenceEquals(bl.get_hostId(), bj.get_hostId())) {
                        bl = this.$0(bi);
                    }
                ...
                $2: function (e) {
                    ...
                    if (bk.get_result() === "api.success") {
                        switch (bj.get_successCallbackTiming()) {
                            ...
                            default: {
                                throw q.createInternalError("Unknown timing value: " + bj.get_successCallbackTiming());
                            }
                        }
                ...
                $0: function (e) {
                    ...
                    try {
                        while (bi.moveNext()) {
                            var bj = bi.current();
                            if (this.$6.hasOwnProperty(bj.key) && ss.referenceEquals(bj.value.get_iframe().contentWindow, e.source)) {
                                return bj.value;
                            }
                        }
                    } finally {
        ...
        var P = (global.tab.DataType = ss.mkEnum(a, "tab.DataType", { float: "float", integer: "integer", string: "string", boolean: "boolean", date: "date", datetime: "datetime" }, true));
        ...
        var R = (global.tab.FilterCommandsBuilder = ss.mkType(a, "tab.FilterCommandsBuilder", function () {}, {
            ...
            buildRelativeDateFilterCommandParams: function (e, bi) {
                ...
                if (ss.isValue(bi)) {
                    ...
                    if (ss.isValue(bi.anchorDate)) {
                        bj["api.filterDateArchorValue"] = r.serializeDateForServer(bi.anchorDate);
                    }
                }
                return bj;
            },
            ...
            filterCommandError: function (e) {
                ...
                if (ss.isValue(bi) && ss.isValue(bi.errorCode)) {
                    var bj = ss.isValue(bi.additionalInformation) ? bi.additionalInformation.toString() : "";
                    switch (bi.errorCode) {
            ...
            normalizeRangeFilterOption: function (e) {
                ...
                if (ss.isNullOrUndefined(e.min) && ss.isNullOrUndefined(e.max) && ss.isNullOrUndefined(e.nullOption)) {
                    throw q.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max or filterOptions.nullOption must be specified.");
                }
                var bi = new Object();
                if (ss.isValue(e.min)) {
                    bi.min = e.min;
                ...
                if (ss.isValue(e.nullOption)) {
                    bi.nullOption = Y.normalizeEnum(D).call(null, e.nullOption, "filterOptions.nullOption");
                }
                return bi;
            },
            normalizeRelativeDateFilterOptions: function (e) {
                ...
                bi.periodType = Y.normalizeEnum(G).call(null, e.periodType, "filterOptions.periodType");
                if (bi.rangeType === "lastn" || bi.rangeType === "nextn") {
        ...
        var S = (global.tab.GetDataCommandsBuilder = ss.mkType(a, "tab.GetDataCommandsBuilder", function () {}, {
            ...
            $2: function (e) {
                ...
                for (var bj = 0; bj < e.length; bj++) {
                    var bk = e[bj];
                    var bl = new j(bk.fieldName, v.convertDataType(bk.dataType), bk.isReferenced, bk.index);
                    bi.push(new bd(bl));
                }
                return bi;
            },
        ...
        var Y = (global.tab.PublicEnums = ss.mkType(a, "tab.PublicEnums", null, null, {
        ...
        var Z = (global.tab.SharedUtils = ss.mkType(a, "tab.SharedUtils", function () {}, {
        ...
        var bb = (global.tab.SheetSizeFactory = ss.mkType(a, "tab.SheetSizeFactory", null, null, {
        ...
        var bh = (global.tableauSoftware.Pair = ss.mkType(a, "tableauSoftware.Pair", function (e, bi) {
            this.fieldName = null;
            this.value = null;
    ...
    (function () {
        ...
        var j = (global.tab._ApiBootstrap = ss.mkType(a, "tab._ApiBootstrap", null, null, {
            initialize: function () {
        ...
        var k = (global.tab._CustomViewImpl = ss.mkType(
            ...
            },
            {
                ...
                _makeCurrentCustomViewDefaultAsync: function (e, bn) {
                    ...
                    var bp = {};
                    var bq = k.$0("api.MakeCurrentCustomViewDefaultCommand", bo, function (br) {
                ...
                $1: function (e, bn, bo, bp, bq) {
                    ...
                    if (ss.isValue(br) && ss.referenceEquals(bu.$5(), br) && ss.referenceEquals(bu.$7(), bs)) {
                        e.$c(bu.$3());
                    }
                },
                $0: function (e, bn, bo) {
                    ...
                    return new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(e, 0, bo, bp);
                },
            }
        ));
        var l = (global.tab._DashboardImpl = ss.mkType(
            ...
            },
            {
                ...
                $c: function (e, bn) {
                    ...
                    for (var bo = 0; bo < e.length; bo++) {
                        ...
                        if (e[bo].objectType === "worksheet") {
                            ...
                            var bx = bw ? "" : bv.getUrl();
                            var by = o.$ctor(br, "worksheet", bs, bt, this.get_workbook(), bx, bu, bw, bp.zoneId);
                            var bz = new w(by, this.get_workbookImpl(), this.get_messagingOptions(), this);
                            bq = bz.get_worksheet();
                    ...
                    var bo = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                        ...
                        ss.mkdel(this, function (bp) {
                            ...
                            try {
                                while (bs.moveNext()) {
                                    var bt = bs.current();
                                    for (var bu = 0; bu < this.get_worksheets().get__length(); bu++) {
                                        if (ss.referenceEquals(this.get_worksheets().get_item(bu)._impl.get_name(), bt)) {
                                            var bv = new Object();
                                            bv.filters = Array.prototype.slice.call(bp.filters[bt]);
                                            var bw = bv;
                                            var bx = X.processFiltersList(this.get_worksheets().get_item(bu)._impl, bw);
                ...
                $d: function (e, bn, bo, bp) {
                    ...
                    var bs = this.$i.createFilterCommandReturnHandler("api.ApplyDashboardCategoricalFilterCommand", e, br);
            ...
            },
            {
                processDataSource: function (e) {
                    ...
                    for (var bp = 0; bp < bo.length; bp++) {
                        ...
                        var bs = tab.ApiEnumConverter.convertFieldAggregation(bq.aggregation);
        ...
        var n = (global.tab._SheetImpl = ss.mkType(
            ...
            },
            {
                ...
                changeSizeAsync: function (e) {
                    ...
                    var bq = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                        "api.SetSheetSizeCommand",
                        0,
                        ss.mkdel(this, function (br) {
                            this.get_workbookImpl()._update(
                                ss.mkdel(this, function () {
                                    var bs = this.get_workbookImpl().get_publishedSheets()._get(this.get_name()).getSize();
                                    bn.resolve(bs);
                                })
                            );
                        }),
            ...
            },
            {
                ...
                $1: function (e) {
                    var bn = tab.PublicEnums.normalizeEnum(tab.ApiSheetSizeBehavior).call(null, e.behavior, "size.behavior");
                    var bo = e.minSize;
                    if (ss.isValue(bo)) {
        ...
        var o = (global.tab._SheetInfoImpl = ss.mkType(a, "tab._SheetInfoImpl", null, null, {
        ...
        var p = (global.tab._StoryImpl = ss.mkType(
            ...
            },
            {
                ...
                update: function (e) {
                    ...
                    var bw = ss.isNullOrUndefined(this.$g) || this.$g.get_storyPointId() !== bo.storyPointId;
                    if (ss.isValue(this.$g) && bw) {
                        this.$g.set_isActive(false);
                    }
                    var bx = this.$g;
                    if (bw) {
                        var by = q.createContainedSheet(bn, this.get_workbookImpl(), this.get_messagingOptions(), this.$h);
                        this.$g = new q(bo, by);
                    } else {
                ...
                $f: function (e, bn) {
                    ...
                    if (bo.storyPointId !== bn.storyPointId) {
                        throw tab._TableauException.createInternalError("We should not be updating a story point where the IDs don't match. Existing storyPointID=" + bo.storyPointId + ", newStoryPointID=" + bn.storyPointId);
                    }
                ...
                $e: function (e) {
                    ...
                    var br = q.createContainedSheet(e.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$h);
                    bq.isActive = true;
                    this.$g = new q(bq, br);
        ...
        var q = (global.tab._StoryPointImpl = ss.mkType(
            ...
            },
            {
                createContainedSheet: function (e, bn, bo, bp) {
                    ...
                    var bw = bv ? "" : bu.getUrl();
                    var bx = o.$ctor(e.name, bq, br, bs, bn.get_workbook(), bw, bt, bv, e.zoneId);
        ...
        var r = (global.tab._StoryPointInfoImpl = ss.mkType(a, "tab._StoryPointInfoImpl", null, null, {
            ...
            $4: function (e) {
                ...
                for (var bo = 0, bp = t.$6.length; bo < bp; bo++) {
                    if (ss.referenceEquals(t.$6[bo].getParentElement(), bn)) {
                        var bq = "Another viz is already present in element '" + tab._Utility.elementToString(bn) + "'.";
        ...
        var u = (global.tab._VizParameters = ss.mkType(
            ...
            function (e, bn, bo) {
                ...
                if (ss.isValue(bo.height) || ss.isValue(bo.width)) {
                    ...
                    this.width = ss.isValue(bo.width) ? tab._Utility.roundVizSizeInPixels(bo.width.toString()) : null;
                } else {
                    this.fixedSize = false;
                }
                ...
                if (ss.isNullOrUndefined(bq) || (bq[0].toLowerCase().indexOf("http://") === -1 && bq[0].toLowerCase().indexOf("https://") === -1)) {
            ...
            },
            {
                ...
                $0: function () {
                    ...
                    var bn = !this.fixedSize && !(this.userSuppliedParameters.indexOf(":size=") !== -1) && this.parentElement.clientWidth * this.parentElement.clientHeight > 0;
                    if (bn) {
                        e.push(":size=");
        ...
        var v = (global.tab._WorkbookImpl = ss.mkType(
            ...
            },
            {
                ...
                $o: function (e) {
                    ...
                    if (ss.isValue(this.$s) && ss.referenceEquals(this.$s.get_name(), bn)) {
                        return;
                    }
                    if (ss.isValue(this.$s)) {
                        ...
                        if (this.$s.get_sheetType() === "story") {
                            var bq = this.$s;
                            bq.remove_activeStoryPointChange(ss.mkdel(this.$D, this.$D.raiseStoryPointSwitch));
                        }
                    }
                    if (ss.isValue(this.$r)) {
                        var br = o.$ctor(this.$r.get_name(), "worksheet", -1, this.$r.get_size(), this.get_workbook(), "", true, true, 4294967295);
                        this.$r = null;
                        ...
                        if (bs.sheetType === "dashboard") {
                            ...
                            this.$s = by;
                            by.add_activeStoryPointChange(ss.mkdel(this.$D, this.$D.raiseStoryPointSwitch));
                        } else {
                ...
                $m: function (e) {
                    ...
                    for (var bo = 0; bo < bn.length; bo++) {
                        ...
                        if (ss.isNullOrUndefined(br)) {
                            ...
                            var bv = o.$ctor(bq, bu, bo, bs, this.get_workbook(), bp.repositoryUrl, bt, false, 4294967295);
                            br = new bd(bv);
                            this.$A._add(bq, br);
                        } else {
                            br.$0.size = bs;
                ...
                $2: function (e, bn) {
                    ...
                    this.$w = null;
                    var bt = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                        "api.SetParameterValueCommand",
                        0,
                        ss.mkdel(this, function (bu) {
                            if (ss.isNullOrUndefined(bu)) {
                                bo.reject(tab._TableauException.create("serverError", "server error"));
                                return;
                            }
            ...
            },
            {
                $0: function (e) {
                    ...
                    for (var bo = 0; bo < e.length; bo++) {
                        var bp = e[bo];
                        var bq = tab.ApiEnumConverter.convertDashboardObjectType(bp.zoneType);
                        var br = tab.Size.$ctor(bp.width, bp.height);
                        var bs = tab.Point.$ctor(bp.x, bp.y);
                        var bt = bp.name;
                        var bu = { name: bt, objectType: bq, position: bs, size: br, zoneId: bp.zoneId };
                        bn.push(bu);
                    }
                    return bn;
                },
        ...
        var w = (global.tab._WorksheetImpl = ss.mkType(
            ...
            },
            {
                    ...
                    var bp = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                        ...
                        function (bq) {
                            ...
                            if (ss.isValue(br)) {
                                ...
                                bn.reject(tab._TableauException.createServerError("Data source '" + e + "' not found"));
                            }
                        },
                        function (bq, br) {
                            bn.reject(tab._TableauException.createServerError(br));
                ...
                $L: function () {
                    ...
                    var bo = ss.isValue(this.get_parentStoryPointImpl()) && this.get_parentStoryPointImpl().get_parentStoryImpl().get_isActive();
                    if (!e && !bn && !bo) {
                        throw tab._TableauException.createNotActiveSheet();
                    }
                },
                $z: function (e) {
                    if (ss.isValue(this.get_parentStoryPointImpl())) {
                        ...
                        bn.dashboard = ss.isValue(this.get_parentDashboardImpl()) ? this.$Q.get_name() : this.get_name();
                        ...
                        var bo = ss.isValue(this.get_parentDashboardImpl()) ? this.get_parentDashboardImpl().get_name() : null;
                ...
                $m: function (e, bn, bo) {
                    if (!tab._Utility.isNullOrEmpty(e) && !tab._Utility.isNullOrEmpty(bn)) {
                    ...
                    var bq = {};
                    this.$z(bq);
                    if (!tab._Utility.isNullOrEmpty(bn) && tab._Utility.isNullOrEmpty(e)) {
                    ...
                    bq["api.filterRelevantValuesOnly"] = ss.isNullOrUndefined(bo.relevantValuesOnly) ? true : bo.relevantValuesOnly;
                    var br = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                ...
                $n: function (e) {
                    ...
                    bo["api.filterRelevantValuesOnly"] = ss.isNullOrUndefined(e.relevantValuesOnly) ? true : e.relevantValuesOnly;
                    var bp = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
                ...
                $j: function (e, bn) {
                    ...
                    var bp = function (br) {
                        ...
                        if (ss.isValue(bs.sharedFilterWorksheetInfoList)) {
                            for (var bu = 0; bu < bs.sharedFilterWorksheetInfoList.length; bu++) {
                ...
                $x: function (e, bn, bo, bp) {
                    ...
                    var br = ss.mkdel(this, function (bt) {
                        ...
                        if (!ss.isValue(bu.sharedFilterWorksheetInfoList)) {
                            bq.reject(tab._TableauException.createServerError("The server returned empty pres model for getAppliedWorksheetsAsync()"));
                            return;
                        }
                        for (var by = 0; by < bu.sharedFilterWorksheetInfoList.length; by++) {
                        ...
                        for (var bB = 0; bB < e.length; bB++) {
                            ...
                            if (!ss.contains(bw, bC) && !ss.contains(bx, bC)) {
                                var bD = "The field " + bp + " isn't applicable to the worksheet " + bC;
                        ...
                        var bH = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))("api.SetAppliedWorksheetsCommand", 0, bF, bG);
                ...
                $M: function (e) {
                    return function (bn, bo, bp, bq) {
                        ...
                        br["api.fieldName"] = bo;
                        this.$z(br);
                        var bs = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))("api.GetAppliedWorksheetsCommand", 0, bp, bq);
                ...
                $E: function (e) {
                    ...
                    this.$z(bo);
                    var bp = this.$N.createFilterCommandReturnHandler("api.ClearFilterCommand", e, bn);
                    this.sendCommand(Object).call(this, bo, bp);
                    return bn.get_promise();
                },
                $A: function (e, bn, bo, bp) {
                    ...
                    this.$z(br);
                    var bs = this.$N.createFilterCommandReturnHandler("api.ApplyCategoricalFilterCommand", e, bq);
                    this.sendCommand(Object).call(this, br, bs);
                    return bq.get_promise();
                },
                $C: function (e, bn) {
                    ...
                    this.$z(bo);
                    var bp = new tab._Deferred();
                    var bq = this.$N.createFilterCommandReturnHandler("api.ApplyRangeFilterCommand", e, bp);
                ...
                $D: function (e, bn) {
                    ...
                    this.$z(bo);
                    var bp = new tab._Deferred();
                    var bq = this.$N.createFilterCommandReturnHandler("api.ApplyRelativeDateFilterCommand", e, bp);
                    this.sendCommand(Object).call(this, bo, bq);
                    return bp.get_promise();
                },
                $B: function (e, bn, bo, bp) {
                    ...
                    this.$z(bq);
                    var br = new tab._Deferred();
                    var bs = this.$N.createFilterCommandReturnHandler("api.ApplyHierarchicalFilterCommand", e, br);
                    this.sendCommand(Object).call(this, bq, bs);
                    return br.get_promise();
                },
                ...
                $w: function (e, bn, bo) {
                    ...
                    if (tab._Utility.isString(e) && (tab._jQueryShim.isArray(bn) || tab._Utility.isString(bn) || !tab.PublicEnums.isValidEnum(tab.ApiSelectionUpdateType).call(null, bn))) {
                ...
                $I: function (e, bn) {
                    ...
                    for (var bv = 0; bv < e.length; bv++) {
                        var bw = e[bv];
                        if (ss.isValue(bw.impl.get_tupleId()) && bw.impl.get_tupleId() > 0) {
                            bu.push(bw.impl.get_tupleId());
                        } else {
                            var bx = bw.impl.get_pairs();
                            for (var by = 0; by < bx.get__length(); by++) {
                                var bz = bx.get_item(by);
                                if (bz.hasOwnProperty("fieldName") && bz.hasOwnProperty("value") && !tab._jQueryShim.isFunction(bz.fieldName) && !tab._jQueryShim.isFunction(bz.value)) {
                ...
                $G: function (e, bn, bo, bp, bq, br, bs, bt) {
                    ...
                    if (w.$3.test(bs)) {
                        ...
                        if (ss.isValue(bu.nullOption)) {
                            var by = tab.PublicEnums.normalizeEnum(tab.ApiNullOption).call(null, bu.nullOption, "options.nullOption");
                            bv.nullOption = by;
                        } else {
                ...
                $K: function (e, bn, bo, bp, bq, br, bs, bt) {
                    ...
                    if (!tab._Utility.isNullOrEmpty(bn) && !tab._Utility.isNullOrEmpty(bo)) {
                    ...
                    if (!tab._Utility.isNullOrEmpty(bp) && !tab._Utility.isNullOrEmpty(bq)) {
                    ...
                    if (!tab._Utility.isNullOrEmpty(br) && !tab._Utility.isNullOrEmpty(bs)) {
                    ...
                    var bF = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))(
            ...
            },
            {
                $0: function (e) {
                    ...
                    if (ss.isValue(bn) && ss.isValue(bn.errorCode)) {
                        var bo = ss.isValue(bn.additionalInformation) ? bn.additionalInformation.toString() : "";
                        switch (bn.errorCode) {
                            case "invalidFilterFieldName": {
        ...
        var z = (global.tab.FilterEvent = ss.mkType(
            ...
            },
            {
                ...
                getFilterAsync: function () {
                    return this.$3.get__worksheetImpl().$m(this.$3.get__filterFieldName(), null, null);
                },
            }
        ));
        ...
        var C = (global.tab.IJsApiMessageHandler = ss.mkType(a, "tab.IJsApiMessageHandler"));
            ...
            },
            {
                ...
                $1: function (e, bn) {
                    if (e.get_name() === "layoutInfoReq") {
                        ...
                        if (e.get_name() === "tableau.completed" || e.get_name() === "completed") {
                            bn.handleVizLoad();
        ...
        var H = (global.tab.StoryPointInfoImplUtil = ss.mkType(a, "tab.StoryPointInfoImplUtil", null, null, {
            clone: function (e) {
        ...
        var N = (global.tab.VizImpl = ss.mkType(
            ...
            },
            {
                ...
                getCurrentUrlAsync: function () {
                    var e = new tab._Deferred();
                    var bn = new (ss.makeGenericType(tab.CommandReturnHandler$1, [String]))(
                ...
                $D: function (e) {
                    ...
                    if (bo.behavior === "exactly") {
                        ...
                        switch (bo.behavior) {
                            ...
                            default: {
                                throw tab._TableauException.createInternalError("Unknown SheetSizeBehavior for viz: " + bo.behavior.toString());
                            }
                        }
                    }
                ...
                $b: function () {
                    ...
                    throw tab._TableauException.create("maxVizResizeAttempts", "Viz resize limit hit. The calculated iframe size did not stabilize after " + bn + " resizes.");
                },
                ...
                addEventListener: function (e, bn) {
                    var bo = {};
                    if (!tab.PublicEnums.tryNormalizeEnum(tab.ApiTableauEventName).call(null, e, bo)) {
                ...
                $d: function () {
                    return tab._Utility.noResultPromiseHelper("api.RevertAllCommand", null, this.$1o);
                },
                $a: function () {
                    return tab._Utility.noResultPromiseHelper("api.RefreshDataCommand", null, this.$1o);
                },
                $p: function () {
                ...
                $e: function () {
                    try {
                        if (!tab._Utility.hasWindowPostMessage() || ss.isNullOrUndefined(this.$1j) || !ss.isValue(this.$1j.contentWindow)) {
                            return;
                        }
                    } catch (bp) {
                        return;
                ...
                sendScaleFactor: function (e) {
                    ...
                    var bo = 0;
                    var bp = 0;
                    var bq = new tab.NonApiCommand("sf", [e, bn.toString(), bo.toString(), bp.toString()]);
                    ...
                    this.get__workbookImpl()._update(
                        ss.mkdel(this, function () {
                            if (!ss.staticEquals(this.$1$7, null)) {
                                this.$1$7(new x("customviewload", this.$1u, ss.isValue(e) ? e._impl : null));
                            }
                        })
                    );
                },
                ...
                $11: function (e, bn) {
                    ...
                    var bp = new (ss.makeGenericType(tab.CommandReturnHandler$1, [Object]))("api.InvokeCommandCommand", 0, null, null);
                ...
                $Z: function (e) {
                    if (ss.isValue(this.$1x) && ss.referenceEquals(this.$1x.get_name(), e.get_workbookName())) {
                        this.$14(null);
                    } else {
                        this.$1a();
                    }
                ...
                $T: function (e) {
                    if (ss.staticEquals(this.$1$3, null) || !ss.referenceEquals(this.$1x.get_name(), e.get_workbookName())) {
                        return;
                    }
                    var bn = null;
                ...
                $S: function (e) {
                    if (ss.staticEquals(this.$1$4, null) || !ss.referenceEquals(this.$1x.get_name(), e.get_workbookName())) {
                        return;
                    }
                    var bn = null;
                    var bo = this.$1x.get_activeSheetImpl();
                ...
                $P: function (e) {
                    if (ss.staticEquals(this.$1$5, null) || !ss.referenceEquals(this.$1x.get_name(), e.get_workbookName())) {
                        return;
                    }
                    var bn = null;
                    var bo = this.$1x.get_activeSheetImpl();
                    if (ss.referenceEquals(bo.get_name(), e.get_worksheetName())) {
                        ...
                        } else if (ss.referenceEquals(bs.get_name(), e.get_worksheetName())) {
                            bn = bs;
                        }
                    }
                    if (ss.isValue(bn)) {
                ...
                $M: function (e) {
                    ...
                    if (!ss.staticEquals(this.$1$10, null) && ss.isValue(bn.defaultCustomViewId)) {
                        var bo = this.$1x.$d();
                ...
                $G: function (e, bn) {
                    ...
                    bo.style.background = "transparent url('" + this.$1s.staticImageUrl + "') no-repeat scroll 0 0";
                    bo.style.left = "8px";
        ...
        var X = (global.tableauSoftware.Filter = ss.mkType(
            ...
            },
            {
                ...
                $0: function (e) {
                    ...
                    this.$6 = tab.ApiEnumConverter.convertFieldRole(ss.coalesce(e.fieldRole, "unknown"));
                    this.$3 = tab.ApiEnumConverter.convertFieldAggregation(ss.coalesce(e.fieldAggregation, "NONE"));
                },
            },
            {
                $0: function (e, bn) {
            ...
            },
            {
                ...
                $9: function (e) {
                    if (ss.isValue(e.periodType)) {
                        this.$a = tab.ApiEnumConverter.convertPeriodType(ss.unbox(e.periodType));
                    }
                    if (ss.isValue(e.rangeType)) {
                        this.$c = tab.ApiEnumConverter.convertDateRange(ss.unbox(e.rangeType));
                    }
        ...
        var bk = (global.tableauSoftware.VizManager = ss.mkType(a, "tableauSoftware.VizManager", null, null, {
            getVizs: function () {
                return t.$3();
            },
        }));
