                                        ...
                                        <div class="row mx-3 mt-3">
                                          <div class="col-sm-6">
                                            <div class="row">
                                              ...
                                              <div class="col-sm-6">
                                                <input readonly class="form-control" type="text" :value="exchange_rate_ssp">
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-sm-6">
                                            <div class="row">
                                              ...
                                              <div class="col-sm-6">
                                                <input readonly class="form-control" type="number" min="0" :value="BudgetValueAmountSSP">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row mx-3 pt-3 pb-3 mt-3 bg-light">
                                          <div class="col-sm-4">
                                            <div class="row">
                                              ...
                                              <div class="col-sm-6">
                                                <input v-model="form_transactions.value_amount" @keyup="updateExchangeRates(false)" class="form-control" type="number" min="1"  >
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                        ...
                                        <div class="row mx-3 mt-3">
                                          ...
                                          <div class="col-sm-6">
                                            <div class="row">
                                              ...
                                              <div class="col-sm-6">
                                                <input readonly class="form-control" type="number" min="0" :value="TransactionValueAmountSSP">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row mx-3 pt-3 pb-3 mt-3 bg-light">
                                          <div class="col-sm-4">
                                            <div class="row">
                                              <label for="commitment_amount" class="col-sm-5 col-form-label"><small>Commitment Amount</small></label>
                                              <div class="col-sm-6">
                                                <input v-model="form_transactions.value_amount" @keyup="updateExchangeRates" class="form-control" type="number" min="1"  placeholder="1000000" >
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
...
export default {
  ...
  methods: {
    ...
    removeTransaction(id) {
      if (confirm("Are you sure you want to delete?")) {
        console.log(id);
        if (this.transactions.findIndex(element => element.id === id) !== -1) {
    ...
    fillFormModels() {
      if(this.currentProject !== undefined || this.currentProject !== null)
      {
        ...
        this.transactions = this.currentProject.transaction.map(function(element) {
          return {
            is_db: true,
            id: element.id,
            ref: element.ref,
            ...
            recipient_region_vocabulary: element.iati_recipient_region_vocabulary,
  ...
  if (idParam) {
    ...
    this.getCodelistOptions({codelist: 'AidType', language: this.user?.language}).then(
          (response) => {
            //
            this.aid_type_codes = response.data;
          },
