                      ...
                      <div class="tab-pane fade" id="nav-geographic" role="tabpanel" aria-labelledby="nav-geographic-tab">
                        ...
                        <div class="accordion" id="geographic_allocation_accordion">
                          <div class="accordion-item">
                            ...
                            <div id="geographic_allocation_collapse" class="accordion-collapse collapse " aria-labelledby="geographic_allocation_list" data-bs-parent="#geographic_allocation_accordion">
                              <div class="accordion-body">
...
export default {
  ...
  methods: {
    ...
    removeProjectLocation(index) {
      if (this.project_locations[index] !== undefined) this.project_locations.splice(index, 1);
    },
