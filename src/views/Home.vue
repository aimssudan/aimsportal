<template>
  <main class="page home">
    <div class="container pb-3" style="min-height: 80vh;">
        <div class="col-md-12">
            <div class="card">
